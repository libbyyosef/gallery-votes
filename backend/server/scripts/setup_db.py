...
# This file is .../server/scripts/setup_db.py
# We want .../server/sql_db/schema.sql  => parents[1] is the 'server' folder
...
def apply_schema() -> None:
    ...
    # exec_driver_sql supports multi-statement SQL (DO $$...$$, CREATE VIEW, etc.)
